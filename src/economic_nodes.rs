...
mod tests {
    ...
    impl NodeAPI for MockNodeAPI {
        ...
        async fn subscribe_events(&self, _: Vec<EventType>) -> Result<tokio::sync::mpsc::Receiver<bllvm_node::module::ipc::protocol::ModuleMessage>, bllvm_node::module::traits::ModuleError> {
    ...
    async fn test_economic_node_registration() {
        ...
        let node_id = [1u8; 32];
        let event = ModuleMessage::Event(
            bllvm_node::module::ipc::protocol::EventMessage {
