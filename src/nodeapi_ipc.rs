//! NodeAPI IPC wrapper for Governance module
//!
...
impl NodeAPI for NodeApiIpc {
    ...
    // Filesystem API methods (implemented via IPC)
    ...
    // Storage API methods (implemented via IPC)
    ...
    // Module RPC endpoint registration (implemented via IPC)
    ...
    // Timers and scheduled tasks (callbacks cannot be serialized over IPC)
    // Modules should manage timers locally and use events for coordination
